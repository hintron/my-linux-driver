 ...
 * @see http://derekmolloy.ie/writing-a-linux-kernel-module-part-1-introduction/ for a full description and follow-up descriptions.
*/
...
MODULE_AUTHOR("Michael Hinton");      ///< The author -- visible when you use modinfo
MODULE_DESCRIPTION("A simple Linux driver for educational purposes");  ///< The description -- see modinfo
