...
// The device will appear at /dev/my_linux_driver_2 using this value
#define  DEVICE_NAME "my_linux_driver_2"
...
static int __init my_linux_driver_init(void){
    ...
    if (majorNumber < 0){
        printk(KERN_ALERT "MGH: failed to register a major number\n");
        return majorNumber;
    }
